              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••"
                    className={`w-full bg-white/5 border ${errors.password ? "border-red-500/50" : "border-white/10"} px-4 pr-11 py-3 sm:py-3.5 rounded-xl text-sm sm:text-base text-white placeholder-gray-600 focus:outline-none focus:border-white/30 focus:bg-white/10 transition`}
                    value={password}
                    onChange={(e) => {
                  ...
                  <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 p-2 rounded-lg text-white/60 hover:text-white hover:bg-white/10 transition"
                  >
                    {showPassword ? (
                      <svg
                        ...
                        aria-hidden="true"
                      >
                        <path d="M10.733 5.076a10.744 10.744 0 0 1 11.205 6.576 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-1.444 2.49" />
                        <path d="M14.084 14.158a3 3 0 0 1-4.242-4.242" />
                        <path d="M17.479 17.499A10.75 10.75 0 0 1 2.062 12.35a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 4.11-5.253" />
                        <path d="M2 2l20 20" />
                      </svg>
                    ) : (
                      <svg
